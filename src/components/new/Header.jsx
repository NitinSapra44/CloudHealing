...
export default function Header1() {
  ...
  return (
    <header className="absolute top-0 left-0 z-50 w-full p-5 bg-transparent">
      <div className="w-[90%]  max-w-screen-2xl mx-auto flex justify-between items-center px-4 py-4 ">
