...
export default function Introankit() {
  return (
    <div className="bg-[#E6EFF4] min-h-screen flex justify-center pb-16">
      <div className="w-[90%] md:w-[80%] border-2 p-8 rounded-[50px] bg-white">
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            {/* Image container */}
            <div className="w-full md:w-[40%] relative aspect-[4/5] md:aspect-auto h-[500px] rounded-lg overflow-hidden">
              <Image
                src="/Ankit-full.png"
                alt="about-us"
                fill
            ...
            {/* Text content */}
            <div className="w-full md:w-[60%] flex flex-col gap-4 sm:gap-6 text-base  font-poppins font-light">
              <p>
